...
from apps.home.views import HomePageView, FaqView, FeedbackView, GuestView, JubileeBookingView
...
urlpatterns = patterns('',
    ...
    url(r'^jubileusz/$', JubileeBookingView.as_view(), name='jubilee_booking'),
